...
function load_random_redirect() {
    // Fix the no valid header issue for the first time activation
	require_once( dirname( __FILE__ ) . '/random-redirect/random-redirect.php' );
}
add_action( 'setup_theme', 'load_random_redirect' );
